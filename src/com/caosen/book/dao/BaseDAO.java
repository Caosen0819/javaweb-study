...
import com.caosen.book.utils.JDBCUtilsByDruid;
import com.caosen.myssm.basedao.ConnUtil;
import com.caosen.myssm.basedao.DAOException;
...
public class BaseDAO<T> {
    ...
    public int update(String sql, Object... paramters) throws SQLException {
        ...
        int update = qr.update(connection, sql, paramters);
    ...
    public List<T> queryMutiple(String sql, Class<T> tClass, Object... paramters){

        Connection connection = null;
        try {
            connection = JDBCUtilsByDruid.getconnection();
            return qr.query(connection, sql, new BeanListHandler<T>(tClass), paramters);
    ...
    public T querySingle(String sql ,Class<T> tClass, Object... paramters){
        Connection connection = null;
        try {
            connection = JDBCUtilsByDruid.getconnection();
            return qr.query(connection, sql, new BeanHandler<T>(tClass), paramters);
        } catch (SQLException e) {
            throw new RuntimeException();
        }finally {
            JDBCUtilsByDruid.close(null, null, connection);
    ...
    public Object queryScalar(String sql, Object... paramters){
        ...
        try {
            connection = JDBCUtilsByDruid.getconnection();
            return qr.query(connection, sql, new ScalarHandler(), paramters);
        } catch (SQLException e) {
            throw new RuntimeException();
        }
    }
